...
class NotificationSchedulePropertiesBindingTest {
    ...
    void contextStartsAndBindsDurationFields() {
        contextRunner.run(context -> {
            ...
            NotificationDeliveryProperties deliveryProperties = context.getBean(NotificationDeliveryProperties.class);
            NotificationRetentionProperties retentionProperties = context.getBean(NotificationRetentionProperties.class);
