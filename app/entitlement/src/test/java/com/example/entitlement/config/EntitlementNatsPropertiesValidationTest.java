...
class EntitlementNatsPropertiesValidationTest {
    ...
    void contextStartsWhenSubjectIsPresent() {
        ...
        contextRunner
                ...
                .run(context -> {
                    ...
                    EntitlementNatsProperties properties = context.getBean(EntitlementNatsProperties.class);
    ...
    private ContextConsumer<AssertableApplicationContext> assertValidationFailure(String expectedField) {
        return context -> {
            ...
            Throwable root = org.assertj.core.util.Throwables.getRootCause(failure);
            assertThat(root)
