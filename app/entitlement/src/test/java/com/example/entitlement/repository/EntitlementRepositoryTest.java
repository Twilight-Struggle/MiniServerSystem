...
class EntitlementRepositoryTest extends AbstractPostgresContainerTest {
    ...
    void upsertGrantIfNotActiveReturnsEmptyWhenAlreadyActive() {
        Optional<EntitlementRecord> first = entitlementRepository.upsertGrantIfNotActive(
                USER_ID,
                SKU,
                BASE_TIME,
                SOURCE,
        ...
        Optional<EntitlementRecord> second = entitlementRepository.upsertGrantIfNotActive(
                USER_ID,
                SKU,
        ...
        List<EntitlementRecord> records = entitlementRepository.findByUserId(USER_ID);
    ...
    void upsertRevokeIfNotRevokedReturnsEmptyWhenAlreadyRevoked() {
        Optional<EntitlementRecord> first = entitlementRepository.upsertRevokeIfNotRevoked(
                USER_ID,
                SKU,
                BASE_TIME,
                SOURCE,
        ...
        Optional<EntitlementRecord> second = entitlementRepository.upsertRevokeIfNotRevoked(
                USER_ID,
                SKU,
                BASE_TIME.plusSeconds(60),
                SOURCE,
