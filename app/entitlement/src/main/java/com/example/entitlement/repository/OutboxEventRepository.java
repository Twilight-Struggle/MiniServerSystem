...
public class OutboxEventRepository {
        ...
        public int insert(UUID eventId,
                        String eventType,
                        String aggregateKey,
                        String payloadJson,
                        Instant createdAt) {
        ...
        public List<OutboxEventRecord> claimPending(int limit, Instant now, Instant leaseUntil, String lockedBy) {
        ...
        public int markFailure(UUID eventId,
                        String lockedBy,
                        int attemptCount,
                        OutboxStatus status,
                        Instant nextRetryAt,
