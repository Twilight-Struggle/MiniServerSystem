...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleInvalidEntitlementTransition(InvalidEntitlementTransitionException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
    ...
    private String resolveUnreadableBodyMessage(HttpMessageNotReadableException ex) {
        String rawMessage = Optional.ofNullable(ex.getMessage()).orElse("");
