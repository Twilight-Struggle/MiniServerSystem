...
assert_contains "${HELM_RENDERED}" "name: matchmaking-circuit-breaker"
assert_contains "${HELM_RENDERED}" "name: entitlement-circuit-breaker"
assert_contains "${HELM_RENDERED}" "name: gateway-matchmaking-timeout"
assert_contains "${HELM_RENDERED}" "name: gateway-entitlement-timeout"
assert_contains "${HELM_RENDERED}" "name: gateway-to-matchmaking-get-ticket"
assert_contains "${HELM_RENDERED}" "name: gateway-to-matchmaking-cancel-ticket"
assert_contains "${HELM_RENDERED}" "name: gateway-to-matchmaking-join-ticket"
assert_contains "${HELM_RENDERED}" "name: gateway-to-matchmaking-default"
assert_contains "${HELM_RENDERED}" "name: gateway-to-entitlement-get-user-entitlements"
assert_contains "${HELM_RENDERED}" "name: gateway-to-entitlement-default"
assert_contains "${HELM_RENDERED}" "timeout: \"10s\""
assert_contains "${HELM_RENDERED}" "perTryTimeout: \"3s\""
assert_contains "${HELM_RENDERED}" "regex: ^/v1/users/[^/]+/entitlements$"
assert_contains "${HELM_RENDERED}" "exact: DELETE"
assert_contains "${HELM_RENDERED}" "prefix: /v1/matchmaking/tickets/"
assert_contains "${HELM_RENDERED}" "prefix: /v1/matchmaking/queues/"
assert_contains "${HELM_RENDERED}" "name: account-allow-gateway"
assert_contains "${HELM_RENDERED}" "name: account-allow-prometheus-scrape"
assert_contains "${HELM_RENDERED}" "name: entitlement-allow-external-payment"
assert_contains "${HELM_RENDERED}" "name: entitlement-allow-prometheus-scrape"
assert_contains "${HELM_RENDERED}" "name: gateway-allow-prometheus-scrape"
assert_contains "${HELM_RENDERED}" "name: matchmaking-allow-prometheus-scrape"
assert_contains "${HELM_RENDERED}" "name: notification-allow-prometheus-scrape"
assert_contains "${HELM_RENDERED}" "/sa/prometheus"
...
assert_contains "${HELM_RENDERED}" "- \"/actuator/prometheus\""
...
assert_contains "${KUSTOMIZE_RENDERED}" "name: prometheus-config"
assert_contains "${KUSTOMIZE_RENDERED}" "name: prometheus"
assert_contains "${KUSTOMIZE_RENDERED}" "prom/prometheus:v2.55.1"
assert_contains "${KUSTOMIZE_RENDERED}" "name: prometheus"
assert_contains "${KUSTOMIZE_RENDERED}" "kind: ServiceAccount"
assert_contains "${KUSTOMIZE_RENDERED}" "name: grafana-datasources"
assert_contains "${KUSTOMIZE_RENDERED}" "name: grafana"
assert_contains "${KUSTOMIZE_RENDERED}" "grafana/grafana:11.2.2"
assert_contains "${KUSTOMIZE_RENDERED}" "metrics_path: /actuator/prometheus"
